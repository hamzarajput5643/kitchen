...
import { selectAuth, updateToken } from '@store/reducers/auth';
        ...
        try {
            ...
            if (data?.isSucceed && data?.data) {
                ...
                if (data?.messages?.email) {
                    formik.setFieldError("email", data.messages?.email[0]);
                }
                if (data?.messages?.password) {
                    formik.setFieldError("password", data.messages?.password[0]);
                }
            } else {
